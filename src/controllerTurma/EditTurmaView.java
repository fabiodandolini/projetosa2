 ...
 */
public class EditTurmaView extends javax.swing.JFrame {

    /**
     * Creates new form EditTurmaView
     */
    public EditTurmaView() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditTurmaView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditTurmaView().setVisible(true);
            }
        });
    }
